...
library IterableMapping
{
  ...
  function insert(itmap storage self, address key, bytes32 value) public returns (bool replaced)
  {
  ...
  function iterate_get(itmap storage self, uint keyIndex) public view returns (address key, bytes32 value)
  {
